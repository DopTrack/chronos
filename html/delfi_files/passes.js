...
{
var items;
	$.get("/forward/inc/all.php", function(data) {
	  items = data.split('\n');
...
timer = setInterval(function () {
	...
	if(seconds_left>=0)
	{
		countdown.innerHTML = "<a href='/passes/?s=25544'>ISS will cross your sky</a> in " + hours + "h " + minutes + "m " + seconds + "s";  
	}
