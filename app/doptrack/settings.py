...
DOPTRACK_CLIENT_KEY = os.environ.get(
    "DOPTRACK_CLIENT_KEY", os.path.join(BASE_DIR, "remote/client.key")
)
DOPTRACK_CLIENT_CRT = os.environ.get(
    "DOPTRACK_CLIENT_CRT", os.path.join(BASE_DIR, "remote/client.crt")
)
DOPTRACK_CA_CERTS = os.environ.get(
    "DOPTRACK_CA_CERTS", os.path.join(BASE_DIR, "remote/server.crt")
)
...
CORS_ORIGIN_WHITELIST = ("www.n2yo.com", "127.0.0.1")
